...
sub_dir = os.path.join(root_dir, "sentinel-agent-main")
backend_dir = os.path.join(sub_dir, "backend") if os.path.exists(os.path.join(sub_dir, "backend")) else os.path.join(root_dir, "backend")
...
class TestHackathonCompliance(unittest.TestCase):
    ...
    def test_03_frontend_netlify_readiness(self):
        ...
        netlify_toml = os.path.join(sub_dir if os.path.exists(sub_dir) else root_dir, "netlify.toml")
        self.assertTrue(os.path.exists(netlify_toml), "netlify.toml must exist.")

        redirects_file = os.path.join(sub_dir if os.path.exists(sub_dir) else root_dir, "public", "_redirects")
        ...
        cluster_component = os.path.join(sub_dir if os.path.exists(sub_dir) else root_dir, "src", "components", "ClusterTopology.tsx")
